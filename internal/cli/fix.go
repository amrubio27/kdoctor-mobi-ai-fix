// adkd fix: stub para Fase 3 (AI Fixer con Quality-Focused Prompting).
//
...
func NewFixCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: `adkd fix --ai mueve los findings detectados a un LLM (Claude Code,
...
Implementación completa: Fase 3 del plan.`,
		RunE: func(cmd *cobra.Command, args []string) error {
			cmd.PrintErrln("\u26a0 adkd fix --ai todavía no implementado (Fase 3 del plan).")
